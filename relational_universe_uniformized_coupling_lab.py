...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--token-open-moderate", action="store_true",
                   help="Alias for --token-open-topologically-closed.")
    p.add_argument("--full-open", action="store_true",
                   help="Preset: seed + triad + delete + swap + birth + death.")
    p.add_argument("--full-open-moderate", action="store_true",
                   help="Alias for --full-open.")
...
def apply_presets(args: argparse.Namespace) -> None:
    if args.token_open_moderate:
        args.token_open_topologically_closed = True
    if args.full_open_moderate:
        args.full_open = True
