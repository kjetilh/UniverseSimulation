...
def build_argparser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--calibration-runs", type=str, default="Documentation/v10b_ensemble_calibration_runs.csv")
    ap.add_argument("--targets", type=str, default="96,192,256")
    ap.add_argument("--seeds", type=int, default=4)
    ap.add_argument("--output-prefix", type=str, default="Documentation/v10c")
    ap.add_argument("--report-md", type=str, default="Documentation/v10c_growth_regime_search.md")
    return ap
...
def main() -> None:
    ...
    report_path.write_text(build_markdown(regime_rows, summary_rows, overlap), encoding="utf-8")
