...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--out-aggregate-csv", type=str, default="uniformized_scan_aggregate.csv")
...
def main() -> None:
    ...
    ensure_parent_dir(args.out_aggregate_csv)
    agg.to_csv(args.out_aggregate_csv, index=False)
    ...
    summary = "\n".join([
        ...
        "",
        f"_Aggregert CSV: `{args.out_aggregate_csv}`_",
        "",
    ])
    ...
    print(json.dumps({
        ...
        "out_aggregate_csv": args.out_aggregate_csv,
