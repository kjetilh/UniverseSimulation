...
- `v17j` kvalifiserte den anbefalte anchor-independent compound-cycle-loven effect-blind. Hvert forslag komponerer to eksakte state-local v17c-sykluser med lengde `2-4`; den andre trekkes fra mellomtilstanden, forward density er `q1*q2`, og reversen er de mapped delreversene i motsatt rekkefolge. Et symmetrisk filter beholder bare blokker med minst `6` netto endrede kanter; filtrerte paths er self-loops uten renormalisering. Den formelle kjøringen hadde `24` chains, `554` retained paths og `152` accepted blocks; svakeste chain hadde `12` retained og `2` accepted. Exact round-trip, reverse involution, pathwise Metropolis-balance og endpoint-integritet passerte `554/554`; compound exercise/movement/resource/endpoints passerte `24/24`; representation covariance `12/12`; per-source qualification `6/6`; maks chain-runtime var `17.250864 s`; source spectrum/effect/proposal-forbidden calls var `0/0/0`. Status er `v17j_anchor_independent_compound_cycle_qualified`. Dette kvalifiserer den implementerte finite proposal-loven, ikke global connectivity, irreducibility, mixing, convergence, stationary sampling, source effect eller fysikk. Neste gate er en separat effect-blind `v17k` matched accepted-work start-memory-sammenligning mot v17h sin expanded single-cycle-lov; source spectrum forblir lukket.
- `v17k` utforte denne effect-blind sammenligningen med de samme seks rommene, frosne startparene og to ferske seedfamilier. v17j compound-loven ble sammenlignet direkte med v17h sin reverse-closed expanded single-cycle-lov ved eksakt `192` aksepterte brutto removed-edge-enheter i hver av `48` kjeder. Effect exclusion og frozen starts passerte; proposal-lovene ble gjenbrukt uten reimplementasjon; exact work/endpoint-integritet, reverse/balance/work-definition, movement/arm-exercise og resource passerte `48/48`. Compound ga retningsmessig lavere cross-start-avstand i `4/6`, men den preregistrerte materielle reduksjonen passerte `0/6`; compound/expanded-ratio var `0.991307-1.003176`, median `0.995490`, mot krav `<=0.90` i alle seks. Compound brukte `28-30` aksepterte blokker mot expanded-armens `57-67` enkeltcykler ved samme bruttoarbeid; nettoarbeid var `190-192`, saa cancellation forklarer ikke nullresultatet. Frossen status er `v17k_compound_no_uniform_matched_work_gain`. Resultatet pensjonerer bare denne konkrete two-subcycle net-6-loven som uniform start-memory-remedy under det frosne designet. Det beviser ikke disconnection, manglende mixing, fravaer av source effect eller at alle store/algebraiske moves feiler. Source spectrum forblir lukket. Neste smale retning er en effect-blind diagnose som skiller utilstrekkelig move-diameter fra accessibility-component-struktur foer en monolittisk long-cycle-proposal velges.
...
Nyere regeladekvansrunder etter v15-listen er `v15ea`, `v16a`, `v16aa`, `v16ab`, `v16ac`, `v16b`, `v16c`, `v16d`, `v16e`, `v16f`, `v16g`, `v16h`, `v16i`, `v16j`, `v16k`, `v16l`, `v16m`, `v16n`, `v16o`, `v16p`, `v16q`, `v16r`, `v16s`, `v16t`, `v16u`, `v16v`, `v16w`, `v16x`, `v16y`, `v16z`, `v17a`, `v17b`, `v17c`, `v17d`, `v17e`, `v17f`, `v17g`, `v17h`, `v17i`, `v17j` og `v17k`; v17k er siste fullforte gate.

Per dagens lokale state er `v11e` den siste frontier-avklaringen. `v12`-`v17k` er de aktive struktur-/transfer-/Lorentz-/defect-/heuristikk-/regeladekvansrundene bygget paa den; se `PROJECT_HISTORY_INDEX.md` for full versjonsrekkefolge.

- Frontier-script: `relational_universe_v11e_band_vs_bridge0075.py`
- Nyeste regeladekvans-gate: `Documentation/v17k_effect_blind_compound_matched_work_start_memory.md` (`v17k_compound_no_uniform_matched_work_gain`; exact work/proposal/movement/exercise/resource `48/48`, material compound-reduksjon `0/6`, ratio `0.991307-1.003176`, median `0.995490`; neste gate skal effect-blind skille move-diameter fra accessibility-component-struktur, source spectrum fortsatt lukket)
