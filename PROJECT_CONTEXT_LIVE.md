...
- neste naturlige steg er direkte per-snapshot route-entry/retention logging; downstream tail/first-high-felter maa ikke behandles som pre-horizon selector
