...
- Arbeidskonklusjon akkurat naa: v15dx sitt beta1-resultat beholdes som en eksakt, algebraisk og regelbetinget sektorlabel i `band_zero_del`. v15dy og v15dz finner verken robust global eller justert lokal dynamikk som skiller sektor `+0` fra `+1`; den preregistrerte stoppregelen pensjonerer derfor beta1 som dynamisk forskningsspor. Ikke bruk mer budsjett paa chord-survival eller nye beta1-observabler uten en ny uavhengig mekanismehypotese. Far-shell/placement-selector-sporet er ogsaa pensjonert som physics-facing signal. Neste hovedretning maa velges uten aa refitte disse negative sporene, og Lorentz-, entanglement-, partikkel- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
