...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet. Clock/depth-relasjonen er reell i simulatoren, men v16h forklarer den parsimonisk med schedulerens totalrate og common-geometry-syntesen er lukket. v16i/v16j finner deretter en uavhengig kausal intervallspektrumkontrast, og v16k gir en positiv fersk primary-arm-komponent, men nullsampleren ma kvalifiseres foer en ny bekreftende holdout. Neste gate er ikke resource-aware null: bruk v16k-DAGene til ren attempt-budget/sampler-kvalifisering uten effektstyrt tuning, og kjor deretter et nytt 12-run holdout med helt nye seeds. Ikke skaler target eller fit dimensjon. Ikke kall signalet manifold, Lorentz-geometri eller spacetime. Adapteren er fortsatt ikke ny core-anchor. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel-, continuum- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
Nyere regeladekvansrunder etter v15-listen er `v15ea`, `v16a`, `v16aa`, `v16ab`, `v16ac`, `v16b`, `v16c`, `v16d`, `v16e`, `v16f`, `v16g`, `v16h`, `v16i`, `v16j` og `v16k`; v16k er siste fullforte gate, men endte med frossen instrumenteringsfeil.
...
- Nyeste regeladekvans-gate: `Documentation/v16k_fresh_strict_null_replication.md` med semantisk audit i `Documentation/v16k_interpretation_audit.md` (`v16k_instrumentation_failed`; valid fersk primary-arm-komponent, men samplerens attempt-budget maa kvalifiseres foer ny holdout)
