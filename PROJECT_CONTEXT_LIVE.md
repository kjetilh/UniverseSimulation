...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet, dagens globale seed-clock er fortsatt uegnet for whole-system intrinsic causality, og den isolerte lokale seed-clock-varianten har passert fresh scheduler-, support/locality-, kommutasjons- og event-DAG-gatene uten refit. Neste gate er en liten preregistrert v16c tre-skala coarse-graining-pilot som fryser kart og ratio-observabler foer dynamikk, med global scheduler som diagnostisk kontroll. Adapteren er fortsatt ikke ny core-anchor; rekalibrering og bred skalaoverfoering gjenstaar. Dette er arkitekturarbeid, ikke Lorentz-/spacetime-evidens. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
- Nyeste regeladekvans-gate: `Documentation/v16b_intrinsic_event_dag_gate.md` (`pass_to_v16c_coarse_graining_pilot`; history-intrinsic DAG holder i fersk smal gate, men er ikke universell kausal orden)
