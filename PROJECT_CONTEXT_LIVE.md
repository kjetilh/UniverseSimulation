...
- neste naturlige steg er ikke aa refitte `delta_return_t2`, men enten nedgradere det til audit eller designe en multi-active/base-landscape observabel som forventer at flere placements kan vaere aktive paa samme base
