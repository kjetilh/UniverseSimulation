...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet. Clock/depth-relasjonen er reell i simulatoren, men v16h forklarer den parsimonisk med schedulerens totalrate og common-geometry-syntesen er lukket. v16i/v16j finner deretter en uavhengig, repeterbar kausal intervallstruktur som overlever grad-, dybde- og global parent-age-kontroll, men med ustabil effektmagnitudetransfer. Neste gate skal vaere en fersk history-replikasjon med effekt-eksistens og effektstorrelse som separate preregistrerte utfall. Ikke skaler target eller fit dimensjon foer den replikasjonen. Ikke kall signalet manifold, Lorentz-geometri eller spacetime. Adapteren er fortsatt ikke ny core-anchor. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel-, continuum- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
Nyere regeladekvansrunder etter v15-listen er `v15ea`, `v16a`, `v16aa`, `v16ab`, `v16ac`, `v16b`, `v16c`, `v16d`, `v16e`, `v16f`, `v16g`, `v16h`, `v16i` og `v16j`; v16j er siste fullforte gate.
...
- Nyeste regeladekvans-gate: `Documentation/v16j_interval_strict_null_gate.md` med semantisk audit i `Documentation/v16j_interpretation_audit.md` (`strict_null_contrast_supported_magnitude_transfer_not_stable`; effekten overlever eksakt in/out-degree, depth og global parent-age-bin-kontroll, men v16h/v16d-magnituderatio `0.469661` feiler den frosne nedre grensen `0.5`)
