...
- `v17b` utfoerte denne residual-cycle-gaten effect-blind paa de samme seks state-rommene, startene, seedfamiliene og 512-stegsbudsjettene. Frozen-start replay og representation covariance passerte `12/12`; exact reverse support og pathwise detailed balance passerte `36/36`; source spectrum/effect calls var `0/0`. Valid-proposal-yield forbedret seg mot matchet v17a i `24/24` kjeder med median ratio `2.898276`, og finite movement passerte naa `24/24`. Ressursgaten feilet derimot: bare `12/24` kjeder holdt `<=60 s`, runtime var `27.479260-270.449001` sekunder, og bare `1/6` source-celler passerte alle fire runtime-krav. Frossen status er `v17b_resource_not_qualified`. Post-run viser at length-4-sekvenser utgjoer `0.965295` av registrert completion-masse, men completion-masse forklarer runtime svakt (`Pearson r=0.125554`); sporingen teller ikke feilede grener eller allokeringskost. Statisk enumererer implementasjonen forward-settet to ganger og materialiserer alle fullforte sykluser. Neste smale gate er `v17c_exact_counter_runtime_qualification`: behold eksakt proposal-lov og alle terskler, men tell/sampl uniformt uten duplisert forward-enumerering eller full materialisering. Ikke aapne spectrum/effect, stabilitet, Bell, entanglement eller Lorentz foer resource `24/24`.
...
Nyere regeladekvansrunder etter v15-listen er `v15ea`, `v16a`, `v16aa`, `v16ab`, `v16ac`, `v16b`, `v16c`, `v16d`, `v16e`, `v16f`, `v16g`, `v16h`, `v16i`, `v16j`, `v16k`, `v16l`, `v16m`, `v16n`, `v16o`, `v16p`, `v16q`, `v16r`, `v16s`, `v16t`, `v16u`, `v16v`, `v16w`, `v16x`, `v16y`, `v16z`, `v17a` og `v17b`; v17b er siste fullforte gate.

Per dagens lokale state er `v11e` den siste frontier-avklaringen. `v12`-`v17b` er de aktive struktur-/transfer-/Lorentz-/defect-/heuristikk-/regeladekvansrundene bygget paa den; se `PROJECT_HISTORY_INDEX.md` for full versjonsrekkefolge.

- Frontier-script: `relational_universe_v11e_band_vs_bridge0075.py`
- Nyeste regeladekvans-gate: `Documentation/v17b_residual_cycle_constructor_gate.md` (`v17b_resource_not_qualified`; representation `12/12`, reverse support og pathwise balance `36/36`, matched yield og movement `24/24`, men resource `12/24`; neste gate skal optimere eksakt counting/sampling uten aa endre proposal-loven)
