...
- neste naturlige steg er aa avlede tidligere pre-entry features fra `v15dd_direct_route_snapshot_log.csv`, ikke bruke direct route outcome som predictor
