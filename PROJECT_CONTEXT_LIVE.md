...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet, dagens globale seed-clock er fortsatt uegnet for whole-system intrinsic causality, og den isolerte lokale seed-clock-varianten har passert fresh scheduler-, support/locality-, kommutasjons-, event-DAG-, tre-skala coarse-map-, target-transfer- og independent-clock-map-gatene uten refit. Neste gate er ett preregistrert v16f cross-map relation-test som kvantifiserer om clock-slab- og causal-depth-quotientene er mer relaterte enn size-/order-matchede nullkart paa samme ferske historier. Ikke legg til et tredje kart eller skaler target foerst. Adapteren er fortsatt ikke ny core-anchor. Dette er arkitekturarbeid, ikke Lorentz-/spacetime-evidens. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel-, continuum- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
Nyere regeladekvansrunder etter v15-listen er `v15ea`, `v16a`, `v16aa`, `v16ab`, `v16ac`, `v16b`, `v16c`, `v16d` og `v16e`; v16e er siste fullforte gate.
...
- Nyeste regeladekvans-gate: `Documentation/v16e_clock_slab_map_gate.md` (`pass_to_v16f_cross_map_relation_gate`; simulation-clock slabs har repeterbar dependency-clustering utover nullkontroller, men er scheduler-order-dependent og ikke proper time, spacetime eller universell kausal orden)
