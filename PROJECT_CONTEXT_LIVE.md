...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet, dagens globale seed-clock er fortsatt uegnet for whole-system intrinsic causality, og den isolerte lokale seed-clock-varianten har passert fresh scheduler-, support/locality-, kommutasjons-, event-DAG-, tre-skala coarse-map- og target-transfer-gatene uten refit. Neste gate er ett preregistrert v16e-map-kontrast der primaerkartet ikke defineres av causal-depth-vinduer, med relabel-invarians, konkrete witnesses og null/coarsening-kontroller. Samme depth-map skal ikke skaleres videre som standard. Adapteren er fortsatt ikke ny core-anchor; rekalibrering og uavhengige geometriobservabler gjenstaar. Dette er arkitekturarbeid, ikke Lorentz-/spacetime-evidens. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
- Nyeste regeladekvans-gate: `Documentation/v16d_target_scale_holdout.md` (`pass_to_v16e_independent_coarse_map_gate`; det uendrede finite tre-skala-kartet transfererer fra target 1024 til 1536, men er ikke continuum, spacetime eller universell kausal orden)
