...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet, og den isolerte lokale seed-clock-varianten har passert den endelige arkitekturkjeden gjennom event-DAG, depth-coarse-map, target-transfer og uavhengig clock-map. Cross-map-syntesen ga ikke common-geometry-stotte; den ga en robust relativ anti-alignment som maa mekanismeforklares. Neste gate er ett preregistrert v16g-test av om event-family og lokal rate forklarer hvor clock-grenser kutter depth-komponenter. Ikke legg til et tredje kart eller skaler target foerst. Adapteren er fortsatt ikke ny core-anchor. Dette er arkitekturarbeid, ikke Lorentz-/spacetime-evidens. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel-, continuum- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
Nyere regeladekvansrunder etter v15-listen er `v15ea`, `v16a`, `v16aa`, `v16ab`, `v16ac`, `v16b`, `v16c`, `v16d`, `v16e` og `v16f`; v16f er siste fullforte gate.
...
- Nyeste regeladekvans-gate: `Documentation/v16f_cross_map_relation_gate.md` (`pass_to_v16g_clock_depth_boundary_mechanism_gate`; clock/depth-partisjonene har stabil relativ anti-alignment mot tre kronologiske kontroller, men er ikke validert som en felles geometri eller fysisk romtid)
