...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet, og den isolerte lokale seed-clock-varianten har passert arkitekturkjeden gjennom event-DAG, depth-coarse-map, target-transfer og uavhengig clock-map. Cross-map-syntesen ga ikke common-geometry-stotte. v16g viser at den robuste v16f-anti-aligneringen forelopig best forstaas som indusert av schedulerens totale rateprofil, ikke som en uavhengig geometri; event-family og konkret hazard gir ingen synlig ekstra medianforklaring. Neste gate er ett ferskt v16h dynamisk holdout som logger pre-event-rater direkte og bruker samme frosne residual-nulltest. Ikke legg til et tredje kart eller skaler target foerst. Adapteren er fortsatt ikke ny core-anchor. Dette er arkitekturarbeid, ikke Lorentz-/spacetime-evidens. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel-, continuum- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
Nyere regeladekvansrunder etter v15-listen er `v15ea`, `v16a`, `v16aa`, `v16ab`, `v16ac`, `v16b`, `v16c`, `v16d`, `v16e`, `v16f` og `v16g`; v16g er siste fullforte gate.
...
- Nyeste regeladekvans-gate: `Documentation/v16g_clock_depth_boundary_mechanism_gate.md` (`pass_to_v16h_fresh_rate_logged_mechanism_holdout`; v16f-anti-aligneringen forklares nesten fullt av pre-event totalrateprofilen i en frosset analyse-holdout, men mekanismen er ikke en felles geometri eller fysisk romtid og trenger fersk direkte-logget validering)
