...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet. Clock/depth-relasjonen er reell i simulatoren, men v16h forklarer den parsimonisk med schedulerens totalrate og common-geometry-syntesen er lukket. V16m replikerte en kausal intervallspektrumkontrast under strict-null; v16o-v16q fant og kvalifiserte en grovere event-footprint-null; v16r beholdt kontrasten posthoc; v16s replikerte den paa seks ferske historier. V16t fullforte en effect-blind nullsenter-gate med `384/384` gyldige perturbasjoner og en frossen pass-status, men den nyere realized-effort-auditen avgrenser tolkningen: direct short/reference/long realiserte omtrent samme antall aksepterte swaps (`993/1005/998` i snitt), mens staged realiserte `2023`. Dermed ble verken direkte kjedelengde eller matched-effort path-segmentering isolert. Korrekt status er `v16t_center_stability_observed_but_length_path_decomposition_inconclusive`. Neste gate maa skille `10%` burn-in fra eksakt `+K/+2K` realisert arbeid og matche direkte `+2K` mot staged `+K+K`, fortsatt uten kildespekter. Ikke skaler target eller fit dimensjon ennaa. Ikke kall signalet manifold, Lorentz-geometri eller spacetime. Adapteren er fortsatt ikke ny core-anchor. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel-, continuum- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
Nyere regeladekvansrunder etter v15-listen er `v15ea`, `v16a`, `v16aa`, `v16ab`, `v16ac`, `v16b`, `v16c`, `v16d`, `v16e`, `v16f`, `v16g`, `v16h`, `v16i`, `v16j`, `v16k`, `v16l`, `v16m`, `v16n`, `v16o`, `v16p`, `v16q`, `v16r`, `v16s` og `v16t`; v16t er siste fullforte gate.
...
- Nyeste regeladekvans-gate: `Documentation/v16t_footprint_null_path_stability_gate.md` med nyere `Documentation/v16t_realized_effort_interpretation_audit.md` (`v16t_center_stability_observed_but_length_path_decomposition_inconclusive`; frossen pass-status beholdes, men faktisk chain/path-dekomponering er ikke validert)
