...
- neste naturlige steg er aa fryse `w32_mean_boundary_per_mass` i en pre-registrert holdout, med statisk supportgeometri rapportert eksplisitt som placement-confound/audit
