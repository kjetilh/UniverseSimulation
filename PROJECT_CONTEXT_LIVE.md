...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet, dagens globale seed-clock er fortsatt uegnet for whole-system intrinsic causality, og den isolerte lokale seed-clock-varianten har passert fresh scheduler-, support/locality-, kommutasjons-, event-DAG- og tre-skala coarse-map-gatene uten refit. Neste gate er ett preregistrert v16d scale-holdout med uendret map og ratioer paa en ny target- eller event-budget-akse. Adapteren er fortsatt ikke ny core-anchor; rekalibrering, bred skalaoverfoering og uavhengige geometriobservabler gjenstaar. Dette er arkitekturarbeid, ikke Lorentz-/spacetime-evidens. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
- Nyeste regeladekvans-gate: `Documentation/v16c_three_scale_coarse_graining_pilot.md` (`pass_to_v16d_scale_holdout`; ett frosset tre-skala quotient-kart holder i fersk smal gate, men er ikke continuum, spacetime eller universell kausal orden)
