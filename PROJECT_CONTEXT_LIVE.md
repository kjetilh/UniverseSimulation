...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet. Clock/depth-relasjonen er reell i simulatoren, men v16h forklarer den parsimonisk med schedulerens totalrate og common-geometry-syntesen er lukket. V16m replikerte en kausal intervallspektrumkontrast under strict-null; v16o-v16q fant og kvalifiserte en grovere event-footprint-null; v16r beholdt kontrasten posthoc; v16s replikerte den paa seks ferske historier. V16t sin realized-effort-audit fant en designkonfundering, og v16u reparerte den effect-blind. V16v bygget deretter en helt global edge-slot-null uten lokale switch-steg og uten source spectra/effect metrics: `48/48` rekonstruksjoner passerte eksakt integritet, alle seks kilder fikk `8/8` distinkte endepunkter, og minste changed-edge fraction per kilde laa mellom `0.574426` og `0.630611`. Korrekt status er `v16v_independent_global_null_family_feasible_and_diverse`. Dette viser konstruksjonsmulighet og diversitet, ikke en kvalifisert eller representativ nullfordeling. Neste gate er v16w effect-blind kvalifisering av den frosne globale familien foer én uavhengig effekttest. `Units of action`/lokal realisert endring er samtidig registrert som mulig vei til emergent energi og effektiv temperatur, men bruk forelopig bare `action density` eller `change intensity`: uniform skalering av alle Gillespie-rater endrer klokkehastighet, ikke embedded event-order-fordelingen. Ikke skaler target eller fit dimensjon ennaa. Ikke kall signalet energi, temperatur, manifold, Lorentz-geometri eller spacetime. Adapteren er fortsatt ikke ny core-anchor. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel-, continuum- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
Nyere regeladekvansrunder etter v15-listen er `v15ea`, `v16a`, `v16aa`, `v16ab`, `v16ac`, `v16b`, `v16c`, `v16d`, `v16e`, `v16f`, `v16g`, `v16h`, `v16i`, `v16j`, `v16k`, `v16l`, `v16m`, `v16n`, `v16o`, `v16p`, `v16q`, `v16r`, `v16s`, `v16t`, `v16u` og `v16v`; v16v er siste fullforte gate.
...
- Nyeste regeladekvans-gate: `Documentation/v16v_global_edge_slot_feasibility_gate.md` (`v16v_independent_global_null_family_feasible_and_diverse`; global konstruksjon og diversitet er etablert effect-blind, men nullfamilien er ikke kvalifisert som representativ fordeling)
