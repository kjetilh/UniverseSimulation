...
- Arbeidskonklusjon akkurat naa: v15-observabelprogrammet er avsluttet, og dagens globale seed-clock er fortsatt uegnet for whole-system intrinsic causality. Den isolerte lokale seed-clock-varianten har naa passert baade fresh scheduler-holdout og full support/locality/commutation-rerun uten refit. `v16b` kan derfor startes som en smal intrinsic event-DAG-gate med adapteren, mens gammel global scheduler beholdes som diagnostisk kontroll. Adapteren er ikke ny core-anchor; senere rekalibrering og skalaoverfoering er fortsatt paakrevd. Dette er arkitekturarbeid, ikke Lorentz-/spacetime-evidens. beta1 beholdes kun som algebraisk sektorlabel, og Lorentz-, entanglement-, partikkel- eller universell-geometri-sprak skal fortsatt ikke oppgraderes.
...
- Nyeste regeladekvans-gate: `Documentation/v16ac_local_seed_adapter_gate.md` (`pass_adapter_to_v16b`; adaptervarianten kan brukes i v16b, men er ikke core-anchor)
