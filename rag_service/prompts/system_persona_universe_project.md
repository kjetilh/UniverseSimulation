...
- Nyeste gate er v17i. Den brukte v16z sin exact pair-derived whole-cycle-basis som positiv kontroll: basis/single-block `6/6`, complement identity `96/96`, independent endpoint integrity `192/192`, finite distance response `6/6`, ratio `0.986207-1.004213`. Formal status er `v17i_pair_basis_positive_control_qualified`. Dette validerer cross-start-observabelen under konstruert tilgjengelighet, men basisen kjenner begge starter og er ikke en state-independent proposal eller global null. Neste gate er anchor-independent state-local large-move qualification, fortsatt effect-blind.
