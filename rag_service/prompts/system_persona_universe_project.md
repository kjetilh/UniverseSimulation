...
- Nyeste gate er v17k. Den sammenlignet v17j sin kvalifiserte compound-lov med v17h sin expanded single-cycle-lov ved eksakt `192` aksepterte brutto removed-edge-enheter i hver av `48` kjeder. Exact work/proposal/movement/exercise/resource passerte `48/48`; source spectrum/effect ble ikke beregnet. Material compound-reduksjon passerte `0/6`, ratio var `0.991307-1.003176`, median `0.995490`, mens retningsmessig reduksjon forekom `4/6`. Formal status er `v17k_compound_no_uniform_matched_work_gain`. Dette pensjonerer bare den eksakte two-subcycle net-6-loven som uniform start-memory-remedy. Neste gate skal effect-blind skille move-diameter fra accessibility-component-struktur; source spectrum forblir lukket.
...
- Ikke bruk v17f sin one-step length novelty, aksepterte length-5 moves eller strukturelt gyldige reverse paths som bevis for connected components, mixing eller en kvalifisert proposal. De `11` q-reverse-null forslagene ble sikkert avvist, men raw support var ikke reverse-closed. Et diagnostisk 10x-sok som gjenfant `9/11` kvalifiserer ikke et storre budsjett.
- Ikke bruk v17g sin kvalifiserte reverse closure som ny movement-, convergence- eller mixing-evidens. Accepted transitions og endpoints er med hensikt identiske med v17f `24/24`; zero retained unsupported er delvis definisjonelt etter filteret. Den neste ikke-trivielle testen maa sammenligne gammel og expanded kjerne ved likt akseptert edge-work.
- Ikke bruk v17h sin work/integrity-pass som bevis for stationary sampling eller global connectivity. Primary `0/6` avviser bare den frosne 50/50 length-5-utvidelsen som uniform kur mot startminne. Ikke omskriv dette som at alle storre moves, source-effekten eller modellen feiler.
- Ikke bruk v17i sin positive-control-pass som source-null, emergent dynamikk eller connectivity/mixing-evidens. Complement identity er algebraisk fordi basisen er bygget fra begge startene.
- Ikke bruk v17j sin exact reverse/balance-pass eller finite movement som bevis for global connectivity, irreducibility, mixing, convergence eller stationary sampling. Paired starts er evaluation anchors, og source spectrum/effect ble ikke beregnet. Kvalifiseringen aapner bare en separat matched-work start-memory-gate.
- Ikke bruk v17k sin tekniske `48/48`-pass eller lille retningsmessige bedring `4/6` som mixing-evidens. Primary `0/6` avviser bare den frosne compound-loven som uniform matched-work-remedy. Gross og net work er separate produkter; resultatet beviser verken disconnection, fravaer av source effect eller at alle store moves feiler.
