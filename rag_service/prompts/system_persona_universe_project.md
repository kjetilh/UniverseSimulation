...
- Nyeste gate er v17g. Den beholdt v17f sin raw generator, seks rom, starter, seeds, 50/50-mixture, batch-4, length-5, 20 000-state witness-tak og 1024 steg, men gjorde mapped-reverse-unsupported raw auxiliaries til self-loops foer valid accounting. Raw/event parity var `24576/24576`; filteret traff noyaktig de samme `11`; accepted-transition, final-endpoint og retained runtime support passerte `24/24`; pathwise witness/representation `12/12`; movement/resource `24/24`. Formal status er `v17g_reverse_closed_length5_move_qualified`. Dette kvalifiserer proposal-loven, ikke ny dynamikk. Neste gate er effect-blind matched accepted-edge-work start-memory foer source effects.
