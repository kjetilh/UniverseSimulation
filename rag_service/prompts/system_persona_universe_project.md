...
- Nyeste gate er v17h. Den sammenlignet gammel length-`2-4`-kjerne med v17g sin reverse-closed 50/50 length-`2-5`-kjerne ved eksakt `192` aksepterte removed-edge-enheter i hver av `48` kjeder. Work/integritet/support/movement/resource passerte `48/48`, og length-5 exercise `24/24`. Primaer material cross-start-reduksjon feilet `0/6`; expanded/old-ratio var `0.980433-1.013939`, median `1.003301`, med bare retningsmessig bedring `3/6`. Formal status er `v17h_expanded_kernel_no_uniform_matched_work_gain`. Terminal exact-work-regelen er symmetrisk, men gir finite conditioning og kan ha liten terminal bias. Pensjoner denne faste length-5-utvidelsen som uniform start-memory-remedy; neste retning er et storre algebraisk deklarert accessibility-move, fortsatt effect-blind.
