...
def build_argparser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--seeds", type=int, default=2, help="growth seeds per ensemble/method")
    ap.add_argument("--output-prefix", type=str, default="/mnt/data/v10b")
...
def main() -> None:
    ...
    Path(f"{prefix}_ensemble_calibration.md").write_text(
        calibration_markdown(summary_rows, overlap_rows, usable_rows),
        encoding="utf-8",
    )
