...
def write_codex_prompts(base_dir: Path) -> List[str]:
    out_paths = []

    p1 = base_dir / "codex_prompt_v0_9b_storrelse_og_asymptotikk.md"
    p1.write_text(
...
""", encoding="utf-8")
    ...
    p2 = base_dir / "codex_prompt_v0_9_plotting_og_finite_size.md"
    p2.write_text(
...
""", encoding="utf-8")
    ...
    p3 = base_dir / "codex_prompt_v0_9_verifikasjon_og_regresjon.md"
    p3.write_text(
...
""", encoding="utf-8")
    ...
    p4 = base_dir / "codex_prompt_assistentkontekst_v0_9.md"
    p4.write_text(
...
def main() -> None:
    ...
    prompt_paths = write_codex_prompts(outdir)
    ...
    bundle = outdir / "relational_universe_bundle_v9.zip"
