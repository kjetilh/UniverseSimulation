...
def build_argparser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--output-prefix", type=str, default="/mnt/data/v10e")
    return ap
...
def main() -> None:
    ...
    Path(f"{prefix}_focused_band_validation.md").write_text(
        build_markdown(regime.name, base_summary, candidate_rows, pair_rows, profile_rows),
        encoding="utf-8",
    )
